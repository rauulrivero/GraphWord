...
class Controller:
    def __init__(self, folder_path, output_json_path):
        """
    ...
    def run(self):
        ...
        # Guardar en formato JSON word_graph
        self.file_manager.save_graph_to_json(word_graph.get_graph(), self.output_json_path)
    ...
    def load_and_process_file(self, file_path):
        ...
        self.update_global_word_frequency(filtered_frecuency_dict)

        return None
    

    def update_global_word_frequency(self, word_frequency_dict):
        """
